0.A program that will assign a random number to the variable n each time it is executed.It print whether the number stored in the variable n is positive or negative
